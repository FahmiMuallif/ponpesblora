	...
	<div class="container">
		<div class="about-main">
			<div class="about-top">
				...
				<p>Berita, Informasi, dan Pengumuman Seputar Pondok Pesantren dan Madrasah Diniyyah Al Fattah Mranggen Demak.</p>
			</div>
 </div>
	</div>
</div>
	...
	<div class="container">
		<div class="events-main">
			...
			<?php
				...
				$tampil=mysql_query("SELECT * FROM berita  ORDER BY id_berita DESC limit 0, 5");
