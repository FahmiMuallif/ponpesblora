...
padding-top:5px;
 ...
 ';
	...
	$xxx.='
		...
		$xxx.= '<tr><td>Semester</td><td>: 1</td></tr>';
 ...
 ';
	...
	$xxx.='
		...
		$carisakit=mysql_query("SELECT * FROM absensi 
					...
					AND (tgl_absensi like '%-07-%' or tgl_absensi like '%-08-%' or tgl_absensi like '%-09-%' or tgl_absensi like '%-10-%' or tgl_absensi like '%-11-%' or tgl_absensi like '%-12-%')");
