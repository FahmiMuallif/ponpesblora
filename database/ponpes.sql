...
INSERT INTO berita VALUES("23","PERKEMBANGAN PESANTREN DI INDONESIA (SALAFI, KHALAFI, MODERN, DAN MA’HAD ‘ALY)","<div class=\"clearfix\">
<div>
...
DROP TABLE IF EXISTS biayapendidikan;
...
INSERT INTO biayapendidikan VALUES("1","makan","170000","2x sehari","Ulya","2017/2018");
INSERT INTO biayapendidikan VALUES("2","SPP PONDOK","2400000","SPP PONDOK","Wustho I","2017/2018");
INSERT INTO biayapendidikan VALUES("4","BIAYA ZIAROH","200000","BIAYA&nbsp; ZIAROH","Wustho I","2017/2018");
INSERT INTO biayapendidikan VALUES("5","xxxxx","50000","","Wustho I","2017/2018");

DROP TABLE IF EXISTS biayapendidikandetail;

CREATE TABLE `biayapendidikandetail` (
  `id_detailbiaya` int(11) NOT NULL AUTO_INCREMENT,
  `id_biaya` int(11) NOT NULL,
  `angsuran_ke` varchar(20) NOT NULL,
  `tagihan` int(11) NOT NULL,
  `tgl_terlambat` date NOT NULL,
  PRIMARY KEY (`id_detailbiaya`)
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=latin1;

INSERT INTO biayapendidikandetail VALUES("1","2","1","200000","2017-07-10");
INSERT INTO biayapendidikandetail VALUES("2","2","2","200000","2017-08-10");
INSERT INTO biayapendidikandetail VALUES("3","2","3","200000","2017-09-10");
INSERT INTO biayapendidikandetail VALUES("4","2","4","200000","2017-10-10");
INSERT INTO biayapendidikandetail VALUES("5","2","5","200000","2017-11-10");
INSERT INTO biayapendidikandetail VALUES("6","2","6","200000","2017-12-10");
INSERT INTO biayapendidikandetail VALUES("7","2","7","200000","2018-01-10");
INSERT INTO biayapendidikandetail VALUES("8","2","8","200000","2018-02-10");
INSERT INTO biayapendidikandetail VALUES("9","2","9","200000","2018-03-10");
INSERT INTO biayapendidikandetail VALUES("10","2","10","200000","2018-04-10");
INSERT INTO biayapendidikandetail VALUES("11","2","11","200000","2018-05-10");
INSERT INTO biayapendidikandetail VALUES("12","2","12","200000","2018-06-10");
INSERT INTO biayapendidikandetail VALUES("13","4","#1","100000","2017-09-10");
INSERT INTO biayapendidikandetail VALUES("14","4","#2","100000","2018-04-10");
INSERT INTO biayapendidikandetail VALUES("15","5","#1","50000","2017-08-31");
...
INSERT INTO guru VALUES("2","johnson","Laki-laki","Semarang","994848848","x","x","","johnson","79ab945544e5bc017a2317b6146ed3aa");
INSERT INTO guru VALUES("1","Muhammad","Laki-laki","Semarang","9383736222","Akidah","0","","muh","967c0823cad1084501db462dca54ac1b");
...
INSERT INTO jadwal VALUES("195","1","59","74","1","senin","19.00-21.00","2017/2018");
INSERT INTO jadwal VALUES("194","9","66","74","2","senin","18.00-19.00","2017/2018");
INSERT INTO jadwal VALUES("193","9","66","74","2","senin","15.00-17.00","2017/2018");
INSERT INTO jadwal VALUES("192","1","59","74","8","senin","04.00-05.30","2017/2018");
INSERT INTO jadwal VALUES("191","10","56","68","1","senin","15.00-17.00","2017/2018");
INSERT INTO jadwal VALUES("190","9","57","68","7","senin","04.00-05.30","2017/2018");
INSERT INTO jadwal VALUES("197","16","69","79","8","senin","15.00-17.00","2017/2018");
INSERT INTO jadwal VALUES("198","17","72","79","0","senin","18.00-19.00","2017/2018");
INSERT INTO jadwal VALUES("200","19","78","79","1","senin","04.00-05.30","2017/2018");
INSERT INTO jadwal VALUES("201","19","78","85","1","senin","04.00-05.30","2016/2017");
INSERT INTO jadwal VALUES("204","19","80","86","1","senin","04.00-05.30","2018/2019");

DROP TABLE IF EXISTS jenispelanggaran;

CREATE TABLE `jenispelanggaran` (
  `id_jenispelanggaran` int(11) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`id_jenispelanggaran`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=latin1;

INSERT INTO jenispelanggaran VALUES("1","Melawan secara fisik kepada majlis asatidz","Melawan secara fisik kepada majlis asatidz","Sangat Berat","Dikeluarkan dari pesantren","Pimpinan Pesantren beserta pengurus pesantren");
INSERT INTO jenispelanggaran VALUES("2","Berzina",":: cukup jelas ya..","Sangat Berat","Dikeluarkan dari pesantren","Pimpinan Pesantren beserta pengurus pesantren");
INSERT INTO jenispelanggaran VALUES("3","keluar malam","main ps tidak pakai sendal pulangnya bawa sendal","Sedang","potong gundul","mas zaki");

DROP TABLE IF EXISTS kalenderakademik;

CREATE TABLE `kalenderakademik` (
  `id_kalenderakademik` int(11) NOT NULL AUTO_INCREMENT,
  `tahunajaran` varchar(20) NOT NULL,
  `tgl_mulai` date NOT NULL,
  `tgl_selesai` date NOT NULL,
  `nama_kegiatan` varchar(100) NOT NULL,
  `deskripsi_kegiatan` text NOT NULL,
  PRIMARY KEY (`id_kalenderakademik`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=latin1;

INSERT INTO kalenderakademik VALUES("1","2017/2018","2017-06-01","2018-05-31","Pendaftaran Santri Baru  (Dibuka Sepanjang Tahun)","Pendaftaran Santri Baru");
INSERT INTO kalenderakademik VALUES("2","2017/2018","2018-01-15","2018-01-15","Ujian Semester 1","Ujian Semester 1");
...
INSERT INTO kelas VALUES("81","2a","2017/2018","18","WUSTHO I");
INSERT INTO kelas VALUES("82","2b","2017/2018","16","WUSTHO I");
INSERT INTO kelas VALUES("83","3","2017/2018","","WUSTHO II");
INSERT INTO kelas VALUES("79","1 A","2017/2018","19","WUSTHO I");
INSERT INTO kelas VALUES("80","1b","2017/2018","17","AWALIYAH I");
INSERT INTO kelas VALUES("85","4 A","2016/2017","16","AWALIYAH IV");
INSERT INTO kelas VALUES("86","Awalaiyah 1A","2018/2019","2","AWALIYAH I");

DROP TABLE IF EXISTS kontakkami;
...
INSERT INTO kontakkami VALUES("25","fatimah","fatimah@gmail.com","biaya pondok","berapa biaya bulanan pondok?","2017-07-19","<br />20.000<br /><br /><br /> ---------------------------------------------------------------------------------------------------------------------- berapa biaya bulanan pondok?","0000-00-00");
...
INSERT INTO mapel VALUES("74","1005","Akidah","","","");
INSERT INTO mapel VALUES("72","1003","Nahwu","","","");
INSERT INTO mapel VALUES("73","1004","Shorof","","","");
INSERT INTO mapel VALUES("71","1002","Fiqih","","","");
INSERT INTO mapel VALUES("69","1001","akhlaq","","","");
INSERT INTO mapel VALUES("75","1006","Faraidh","","","");
INSERT INTO mapel VALUES("76","1007","Tajwid","","","");
INSERT INTO mapel VALUES("77","50002","Al-Quran","WUSTHO I","hafalan alquran juz 1-5","");
INSERT INTO mapel VALUES("78","50001","TAUHID","WUSTHO I","Mengartikan Asmaul Husna ok","");
INSERT INTO mapel VALUES("80","A0001","Tauhid","AWALIYAH I","Menyebutkan dan menjelaskan 99 nama allah","2018/2019");
...
INSERT INTO nilai VALUES("1","59","79","78","1","90");
INSERT INTO nilai VALUES("2","58","79","78","1","70");
INSERT INTO nilai VALUES("3","56","79","78","1","60");
INSERT INTO nilai VALUES("4","57","79","78","1","90");
INSERT INTO nilai VALUES("5","58","79","78","2","70");
INSERT INTO nilai VALUES("6","56","79","78","2","70");
INSERT INTO nilai VALUES("7","58","85","78","1","20");
INSERT INTO nilai VALUES("8","56","85","78","1","30");
INSERT INTO nilai VALUES("9","58","85","78","2","10");
INSERT INTO nilai VALUES("10","56","85","78","2","10");
INSERT INTO nilai VALUES("16","59","86","80","2","75");
INSERT INTO nilai VALUES("15","59","86","80","1","90");

DROP TABLE IF EXISTS pelanggaransantri;
...
INSERT INTO pelanggaransantri VALUES("1","10","0","1","2016-08-25","","");
INSERT INTO pelanggaransantri VALUES("3","3","0","1","2016-08-25","","tidak ada");
INSERT INTO pelanggaransantri VALUES("4","1","0","1","2016-08-30","","<div>siswa/santri dikembalikan ke orangtua/wali</div>");
INSERT INTO pelanggaransantri VALUES("5","41","0","1","2017-07-06","2017/2018","");
INSERT INTO pelanggaransantri VALUES("6","54","0","3","0000-00-00","2017/2018","");
INSERT INTO pelanggaransantri VALUES("7","59","79","1","2017-08-06","2017/2018","tendang");

DROP TABLE IF EXISTS pembayaransiswa;
...
INSERT INTO pembayaransiswa VALUES("1","59","79","2017/2018","2","1","200000","2017-07-02","6");
INSERT INTO pembayaransiswa VALUES("2","59","79","2017/2018","2","2","200000","2017-08-02","6");
INSERT INTO pembayaransiswa VALUES("3","59","79","2017/2018","2","3","0","0000-00-00","6");
INSERT INTO pembayaransiswa VALUES("4","59","79","2017/2018","2","4","0","0000-00-00","6");
INSERT INTO pembayaransiswa VALUES("5","59","79","2017/2018","2","5","0","0000-00-00","6");
INSERT INTO pembayaransiswa VALUES("6","59","79","2017/2018","2","6","0","0000-00-00","6");
INSERT INTO pembayaransiswa VALUES("7","59","79","2017/2018","2","7","0","0000-00-00","6");
INSERT INTO pembayaransiswa VALUES("8","59","79","2017/2018","2","8","0","0000-00-00","6");
INSERT INTO pembayaransiswa VALUES("9","59","79","2017/2018","2","9","0","0000-00-00","6");
INSERT INTO pembayaransiswa VALUES("10","59","79","2017/2018","2","10","0","0000-00-00","6");
INSERT INTO pembayaransiswa VALUES("11","59","79","2017/2018","2","11","0","0000-00-00","6");
INSERT INTO pembayaransiswa VALUES("12","59","79","2017/2018","2","12","0","0000-00-00","6");
INSERT INTO pembayaransiswa VALUES("19","59","79","2017/2018","4","#1","100000","2017-07-02","6");
INSERT INTO pembayaransiswa VALUES("20","59","79","2017/2018","4","#2","100000","2017-08-02","6");
INSERT INTO pembayaransiswa VALUES("21","58","79","2017/2018","1","","0","0000-00-00","0");
INSERT INTO pembayaransiswa VALUES("22","58","79","2017/2018","2","","0","0000-00-00","0");
INSERT INTO pembayaransiswa VALUES("23","58","79","2017/2018","4","","0","0000-00-00","0");
INSERT INTO pembayaransiswa VALUES("24","59","79","2017/2018","1","","0","0000-00-00","0");
INSERT INTO pembayaransiswa VALUES("25","59","79","2017/2018","5","#1","50000","2017-08-07","0");
INSERT INTO pembayaransiswa VALUES("26","58","79","2017/2018","2","1","200000","2019-06-23","0");
INSERT INTO pembayaransiswa VALUES("27","58","79","2017/2018","2","2","0","0000-00-00","0");
INSERT INTO pembayaransiswa VALUES("28","58","79","2017/2018","2","3","0","0000-00-00","0");
INSERT INTO pembayaransiswa VALUES("29","58","79","2017/2018","2","4","0","0000-00-00","0");
INSERT INTO pembayaransiswa VALUES("30","58","79","2017/2018","2","5","0","0000-00-00","0");
INSERT INTO pembayaransiswa VALUES("31","58","79","2017/2018","2","6","0","0000-00-00","0");
INSERT INTO pembayaransiswa VALUES("32","58","79","2017/2018","2","7","0","0000-00-00","0");
INSERT INTO pembayaransiswa VALUES("33","58","79","2017/2018","2","8","0","0000-00-00","0");
INSERT INTO pembayaransiswa VALUES("34","58","79","2017/2018","2","9","0","0000-00-00","0");
INSERT INTO pembayaransiswa VALUES("35","58","79","2017/2018","2","10","0","0000-00-00","0");
INSERT INTO pembayaransiswa VALUES("36","58","79","2017/2018","2","11","0","0000-00-00","0");
INSERT INTO pembayaransiswa VALUES("37","58","79","2017/2018","2","12","0","0000-00-00","0");
INSERT INTO pembayaransiswa VALUES("38","58","79","2017/2018","5","#1","50000","2019-06-23","0");
...
INSERT INTO pengguna VALUES("10","SUPER ADMIN","Perempuan","DS MANTINGAN RT 03 RW 01 BULU REMBANG","0856989899","756103th.jpg","admin","21232f297a57a5a743894a0e4a801fc3","Superadmin","Aktif");
INSERT INTO pengguna VALUES("11","STAF KEUANGAN","Laki-laki","DEMAK","08563532628","441589man.png","keuangan","a4151d4b2856ec63368a7c784b1f0a6e","Keuangan","Aktif");
INSERT INTO pengguna VALUES("13","STAF ADMINISTRASI","Laki-laki","Sragen","-","917022woman.png","administrasi","15ff3c0a0310a2e3de3e95c8aeb328d0","Administrasi","Aktif");

DROP TABLE IF EXISTS profil;

CREATE TABLE `profil` (
  `id_profil` tinyint(1) NOT NULL AUTO_INCREMENT,
...
INSERT INTO riwayatkelas VALUES("14","2017","58","79");
INSERT INTO riwayatkelas VALUES("15","2017","56","79");
INSERT INTO riwayatkelas VALUES("16","2016","56","85");
INSERT INTO riwayatkelas VALUES("17","2016","58","85");
INSERT INTO riwayatkelas VALUES("18","2018","59","86");
...
INSERT INTO ruang VALUES("1","Dalam Masjid Lantai #1","Masjid Lantai #1. <br />Kapasitas: 100 orang");
INSERT INTO ruang VALUES("2","Dalam Masjid Lantai #2","DalamMasjid Lantai #2<br />Kapasitas : 100 orang");
INSERT INTO ruang VALUES("8","Serambi Masjid Lantai #1","Luar Masjid Lantai Dasar <br/> Kapasitas : 100 orang");
...
INSERT INTO siswa VALUES("58","32601200438","aktif","2017-07-20","SETIAWAN NANDA PRATAMA","Laki-laki","REMBANG","1993-05-22","9a9c205d65f00a7deef44aef34f1eefa","","JL GEMAH KENCANA 8 NO 1","ALI","BURUH","SUTINEM","-","08563532628","","","");
INSERT INTO siswa VALUES("59","32601200437","keluar","2017-07-20","agus kristian","Laki-laki","batang","1994-05-22","885ab162c1dd604bc797dcb10eee10f4","8910527268-200.png","","","","","","","","","");
INSERT INTO siswa VALUES("56","32601200459","lulus","2017-07-20","riski yudhi prasongko","Laki-laki","brebes","1993-08-21","0c074ab2a292a45bf4b19f0786aa989a","","","","","","","","","","");
INSERT INTO siswa VALUES("57","32601200530","aktif","2017-07-20","zaki mubarok","Laki-laki","demak","1995-05-22","9784ea3da268563469df99b2e6593564","","","","","","","","","","");
INSERT INTO siswa VALUES("60","123456789","aktif","2017-07-20","Kimberli Jo","Perempuan","Semarang","1994-05-22","x","","x","x","x","x","x","x","y","x","x");
INSERT INTO siswa VALUES("61","444444444","aktif","2017-07-20","Kuncrit","Laki-laki","Semarang","1995-05-22","8ce4b16b22b58894aa86c421e8759df3","","k","k","k","k","k","k","k","k","k");
...
INSERT INTO tabungan VALUES("6","59","79","2017/2018","debet","20000","2019-07-01","10");
INSERT INTO tabungan VALUES("8","59","79","2017/2018","debet","100000","2019-07-01","10");
INSERT INTO tabungan VALUES("9","58","79","2017/2018","debet","40000","2019-06-03","0");
...
INSERT INTO tahunajaran VALUES("7","2016/2017","nonaktif");
INSERT INTO tahunajaran VALUES("8","2017/2018","nonaktif");
INSERT INTO tahunajaran VALUES("9","2018/2019","aktif");

DROP TABLE IF EXISTS tatatertibsantri;

CREATE TABLE `tatatertibsantri` (
  `id_tatatertib` int(2) NOT NULL AUTO_INCREMENT,
  `isi_tatatertib` text NOT NULL,
  `file_tatatertib` varchar(100) NOT NULL,
  `tahunajaran` varchar(15) NOT NULL,
  PRIMARY KEY (`id_tatatertib`)
) ENGINE=MyISAM AUTO_INCREMENT=18 DEFAULT CHARSET=utf8;

INSERT INTO tatatertibsantri VALUES("16","<div style=\"text-align: center;\"><strong>&nbsp;</strong></div>
...
INSERT INTO tatatertibsantri VALUES("17","","","2018/2019");
