...
tinymce.init({
 menubar : false,
            ...
            <div class="app" id="app">
				...
				<header class="header">
                    ...
                    <div class="header-block header-block-search hidden-sm-down">
                              <h5> Tahun Ajaran <?php echo $_SESSION[tahunajaran]; ?> </h5>
                    </div>
                    
                    <div class="header-block header-block-nav">
                        <ul class="nav-profile">
							<li class="profile" style="border:none; font-weight: bold;">
								<?php echo $_SESSION[hak_akses]; ?> 
							</li>
                            <li class="profile dropdown">

							   <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
                                     <img src="../upload/foto_guru/<?php echo $_SESSION[foto]; ?>" class="img-responsive" width="32px" style="border-radius:4px;"> <span class="name"> &nbsp; 
                        ...
                        <nav class="menu">
                            <ul class="nav metismenu" id="sidebar-menu">
							   ...
							   <li <?php if($_GET[module]=="home") { echo "class=active";}   ?>>
								 ...
								 <li <?php if($_GET[module]=="jadwalguru") { echo "class=active";}   ?>>
                                    <a href="dashboard.php?module=jadwalguru"> <i class="fa fa-calendar"></i> Jadwal Mengajar </a>
                                </li>
								
							 
								<li <?php if($_GET[module]=="siswa") { echo "class=active";}   ?>>
                                    <a href="dashboard.php?module=siswa"> <i class="fa fa-users"></i> Santri</a>
                                </li>
								
								
								<li <?php if($_GET[module]=="mapel") { echo "class=active";}   ?>>
                                    <a href="dashboard.php?module=mapel"> <i class="fa fa-users"></i> Mata Pelajaran</a>
                                </li>
								
								<li <?php if($_GET[module]=="nilai") { echo "class=active";}   ?>>
                                    <a href="dashboard.php?module=nilai"> <i class="fa fa-sort-alpha-asc"></i> Nilai</a>
                                </li>
			...
			<?php include "content.php"; ?>
			  ...
			  <footer class="footer">
                    ...
                    <div class="footer-block author">
                        <ul>
                            <li> Dibuat Oleh : Universitas Sultan Agung. Semarang. </li>
	...
	$("#pilihanKelas").change(function(){
		...
		var semester = $('#pilihanSemester').val();
		
		if(semester=="") { 
			$('#pilihanSemester option[value=1]').attr('selected','selected');
			<?php $_SESSION[semester_terpilih]=1; ?>
		} 
        ...
        {
            $.getJSON('getMapel.php',{'id_kelas' : getValue, 'semester' : semester},function(data){
                var showData;
...
<!-- inline scripts related to this page -->
	...
	function showAjaxModal(url)
	{
		...
		$('#modal_ajax .modal-body').html('<div style="text-align:center;margin-top:200px;"><img src="../assets/img/preloader.gif" style="height:25px;" /></div>');
    ...
    <div class="modal fade" id="modal_ajax">
        <div class="modal-dialog " >
            <div class="modal-content">
                ...
                <div class="modal-header" style="background-color:#4f5f6f;">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                    <h4 class="modal-title" style="color:#FFF; font-size:15px; font-weight:bolder;">DETAIL SANTRI</h4> 
                </div>
                
                <div class="modal-body" style="height:500px; overflow:auto;"> <!-- style="height:500px; overflow:auto;" -->
                
                    
                    
                </div>
                
                <div class="modal-footer" style="background-color:#4f5f6f;">
