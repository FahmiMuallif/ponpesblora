 ...
 $xxx .= ' 
	...
	$xxx.='
		 <table class="" width="100%">
			<tr><td width="100">Tingkat</td><td>: '. $tingkat.'</td></tr>';
		$xxx.= '<tr><td> Kelas</td><td>: '.$namakelas.'</td></tr>';
		$xxx.= '<tr><td> Semester</td><td>: '.$_GET[smt].'</td></tr>';
		$xxx.= '<tr><td> Mata Pelajaran</td><td>: '.$namamapel.'</td></tr>'; 
		$xxx.= '</table>';
