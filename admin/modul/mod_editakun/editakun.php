 ...
 <?php
    $edit = mysql_query("SELECT * FROM pengguna WHERE id_pengguna='$_SESSION[idadmin]'");
	...
	<form id="formulir" class="form-horizontal" method="post" enctype="multipart/form-data"  action='./modul/mod_editakun/aksi_editakun.php?module=editakun&act=update' role="form" parsley-validate>
  	...
  	<div class="form-group row" >
		...
		<div class="col-sm-4">
		<input type="text" name="nama_lengkap" class="form-control validate[required]" id="nama_lengkap" placeholder="Nama pengguna" value="<?php echo $r[nama_lengkap]; ?>" >
		</div>
	</div>
