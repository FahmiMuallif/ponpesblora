...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 18, 2022 at 08:12 AM
...
(2, 'Hariri', 'Laki-laki', 'Sukabumi', '994848848', 'x', 'x', '', 'hariri', '0220b2f4c4afdfbbc7c0e17224b628c8'),
(1, 'Siti ', 'Perempuan', 'Sukabumi', '9383736222', 'Akidah', '0', '', 'muh', '967c0823cad1084501db462dca54ac1b'),
(0, 'Akbar', 'Laki-laki', 'Sukabumi', '', '', '', '', 'akbar', '4f033a0a2bf2fe0b68800a3079545cd1');
...
(3, '2018/2019', '2022-11-09', '2023-06-30', 'TAHUN AJARAN 2022', 'asd'),
(4, '', '2022-07-11', '2023-06-30', 'TAHUN AJARAN 2022', 'TAHUN AJARAN 2022'),
(5, '2016/2017', '2022-07-11', '2023-06-30', 'TAHUN AJARAN 2022 - 2023', 'TAHUN AJARAN 2022 - 2023'),
(6, '2022/2023', '2022-07-11', '2023-06-30', 'TAHUN AJARAN 2022 - 2023', 'TAHUN AJARAN 2022 - 2023');
...
(10, 'SUPER ADMIN', 'Perempuan', 'Sukabumi', '', '756103th.jpg', 'admin', '7abf4ec0e3370bb3e3f060bd1c8914f1', 'Superadmin', 'Aktif'),
(11, 'STAF KEUANGAN', 'Laki-laki', 'Sukabumi', '', '441589man.png', 'keuangan', '4e0f18d40b2612067104d351f18894f1', 'Keuangan', 'Aktif'),
(13, 'STAF ADMINISTRASI', 'Laki-laki', 'Sukabumi', '-', '917022woman.png', 'administrasi', '7abf4ec0e3370bb3e3f060bd1c8914f1', 'Administrasi', 'Aktif');
...
(1, 'SIPONPES', 'PONDOK PESANTREN HAFIZH MUZHAFFAR', 'JL. SUKABUMI', '0266 - 280622', 'hafizhmuzhaffar@gmail.com', '18logo.png', 'Yayasan Pendidikan Pondok Pesantren Hafizh Muzhaffar Memiliki beberapa lembaga :&nbsp;<br />- Pondok Pesantren Modern<br />- Biro Perjalanan Haji dan Umroh<br />- Majelis Taklim<br />- RA Hafizh Muzhaffar');
...
(59, '32601200437', 'aktif', '2017-07-20', 'agus kristian', 'Laki-laki', 'batang', '1994-05-22', '885ab162c1dd604bc797dcb10eee10f4', '8910527268-200.png', '', '', '', '', '', '', '', '', ''),
(56, '32601200459', 'aktif', '2017-07-20', 'riski yudhi prasongko', 'Laki-laki', 'brebes', '1993-08-21', '0c074ab2a292a45bf4b19f0786aa989a', '', '', '', '', '', '', '', '', '', ''),
...
(61, '444444444', 'aktif', '2017-07-20', 'Kuncrit', 'Laki-laki', 'Semarang', '1995-05-22', '8792b8cf71d27dc96173b2ac79b96e0d', '', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k');
...
(10, '2019/2022', 'nonaktif'),
(11, '2020/2021', 'nonaktif'),
(12, '2021/2022', 'nonaktif'),
(13, '2022/2023', 'aktif');
...
--
ALTER TABLE `jadwal`
  MODIFY `id_jadwal` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=205;
--
...
--
ALTER TABLE `kalenderakademik`
  MODIFY `id_kalenderakademik` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
-- AUTO_INCREMENT for table `kelas`
--
ALTER TABLE `kelas`
  MODIFY `id_kelas` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=87;
--
-- AUTO_INCREMENT for table `kontakkami`
--
ALTER TABLE `kontakkami`
  MODIFY `id_kontak` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
--
-- AUTO_INCREMENT for table `mapel`
--
ALTER TABLE `mapel`
  MODIFY `id_mapel` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=82;
--
...
--
ALTER TABLE `tahunajaran`
  MODIFY `id_tahunajaran` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
--
