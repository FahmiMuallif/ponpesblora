...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 06, 2019 at 04:38 AM
...
CREATE TABLE IF NOT EXISTS `biayapendidikandetail` (
...
(1, 'Muhammad', 'Laki-laki', 'Semarang', '9383736222', 'Akidah', '0', '', 'muh', '967c0823cad1084501db462dca54ac1b');
...
CREATE TABLE IF NOT EXISTS `pelanggaransantri` (
...
CREATE TABLE IF NOT EXISTS `pembayaransiswa` (
...
(10, 'SUPER ADMIN', 'Perempuan', 'DS MANTINGAN RT 03 RW 01 BULU REMBANG', '0856989899', '756103th.jpg', 'admin', '21232f297a57a5a743894a0e4a801fc3', 'Superadmin', 'Aktif'),
...
CREATE TABLE IF NOT EXISTS `riwayatkelas` (
...
(61, '444444444', 'aktif', '2017-07-20', 'Kuncrit', 'Laki-laki', 'Semarang', '1995-05-22', '8ce4b16b22b58894aa86c421e8759df3', '', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k', 'k');
...
CREATE TABLE IF NOT EXISTS `tatatertibsantri` (
