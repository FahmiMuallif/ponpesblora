  ...
  echo "<div class='card'>
				...
				<div class='row text-sm wrapper'>
					<div class='col-sm-6 m-b-xs'>
						   <input type=button class='btn btn-success' value='Tambah Ustad' onclick=location.href='?module=guru&act=tambahguru'></div>
					 
					<div class='col-sm-6'>
						  <a href='modul/mod_guru/aksi_guru.php?module=guru&act=export' target='_blank' class='btn btn-info'>Export</a> ";
				?>

				<div class="pull-right">
				<form class="form-horizontal" action="modul/mod_guru/aksi_guru.php?module=guru&act=impor" method="post" enctype="multipart/form-data">  
