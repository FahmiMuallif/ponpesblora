...
height:18px;
 ...
 $xxx .= ' 
	...
	$xxx.='
		 <center> <h3>LAPORAN PELANGGARAN<br/>';
		if($_GET[kelas]=="Semua"){
			$xxx.= ' '; 
		} else {
			$xxx.= 'TINGKAT '.$tingkat.' /  KELAS '.$namakelas.' <br/>'; 
		}
		$xxx.= ' '.strtoupper($tglAwal).' s/d '.strtoupper($tglAkhir).'</h3>'; 
		$xxx.= '</center>';
	...
	$tglmulai = $_GET[tglAwal]." 00:00:00";
	$tglselesai = $_GET[tglAkhir]." 23:59:59"; 
