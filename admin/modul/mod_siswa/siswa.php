...
switch($_GET[act]){
  ...
  echo "<div class='card'>
				...
				<div class='row text-sm wrapper'>
					...
					<div class='col-sm-6'>
						  <a href='modul/mod_siswa/aksi_siswa.php?module=siswa&act=export' target='_blank' class='btn btn-info'>Export</a> ";
				?>

				<div class="pull-right">
				<form class="form-horizontal" action="modul/mod_siswa/aksi_siswa.php?module=siswa&act=impor" method="post" enctype="multipart/form-data">  
					
					<input type="submit" name="submit" value="Import" class="btn btn-primary pull-right "> 
					<input type="file" class="form-control pull-right" name="file" id="import" style="width:70%; border:0px;"> 
					
					 
				</form>
				</div>
				<small>Impor data, semua kolom data harus terisi. Berikan huruf x jika diperlukan.</small>
	...
	while($r=mysql_fetch_array($tampil)){
		...
		if($r[jenis_kelamin]=="Laki-laki") {
			$r[jenis_kelamin]="L";
		} else if($r[jenis_kelamin]=="Perempuan") {
			$r[jenis_kelamin]="P";
		}
      ...
      echo "<tr><td align=center>$no</td>
			   ...
			   <a href=modul/mod_laporan/cetaksiswa.php?id=$r[id_siswa] class='btn btn-sm btn-info' title='Cetak' target='_blank'>  Cetak</a> 
  ...
  case "editsiswa":
	...
	<div class="form-group row" >
		<label for="nama_lengkap" class="col-sm-5 control-label">SMP/MTs/SD/MI asal</label>
		<div class="col-sm-7">
		<input type="text" name="sekolah_asal" class="form-control" id="nama_lengkap" placeholder="Sekolah Asal" value="<?php echo $r[sekolah_asal]; ?>">
		</div>
	</div>
