...
elseif ($module=='jadwalkelas' AND $act=='input'){
	...
	if (isset($_POST[idruang])) {
			...
			$carijadwallama=mysql_query("SELECT * FROM jadwal where  harimengajar='$hari' and jammengajar='$_POST[jammengajar]' and id_ruang='$idruang' and tahunajaran='$_SESSION[tahunajaran]'");
	...
	if ($_POST[idmapel]!=0) {
			...
			// cek di tabel jadwal 
			//$carijadwallama=mysql_query("SELECT * FROM jadwal where id_kelas='$idkelas' and harimengajar='$hari' and jammengajar='$value'");
			$carijadwallama=mysql_query("SELECT * FROM jadwal where  harimengajar='$hari' and jammengajar='$_POST[jammengajar]' and id_guru='$idguru' and tahunajaran='$_SESSION[tahunajaran]'");
