	...
	<div class="sidebar-container">
		...
		<nav class="menu">
			<ul class="nav metismenu" id="sidebar-menu">
				...
				<li <?php if($_GET[module]=="tatatertib" 
							or $_GET[module]=="jenispelanggaran" 
							or $_GET[module]=="pelanggaransiswa"   ) { echo "class='active open'";}   ?>>
					<a href=""> <i class="fa fa-list"></i> Tata Tertib <i class="fa arrow"></i> </a>
					<ul>
						<li <?php if($_GET[module]=="tatatertib") { echo "class='active'";}   ?>> <a href="dashboard.php?module=tatatertib">
								Tata Tertib
							</a> </li>
							
							 <li <?php if($_GET[module]=="jenispelanggaran") { echo "class='active'";}   ?>> <a href="dashboard.php?module=jenispelanggaran">
								Jenis Pelanggaran
							</a> </li>
							
						<li <?php if($_GET[module]=="pelanggaransiswa") { echo "class='active'";}   ?>> <a href="dashboard.php?module=pelanggaransiswa">
								Pelanggaran Santri
							</a> </li>
				...
				<li <?php if($_GET[module]=="lapnilai" 
					...
					<ul>
						...
						<li <?php if($_GET[module]=="lappelanggaran") { echo "class='active'";}   ?>> <a href="dashboard.php?module=lappelanggaran">
								Lap. Pelanggaran
							</a> </li>
